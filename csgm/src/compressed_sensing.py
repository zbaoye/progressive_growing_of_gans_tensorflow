...
def main(hparams):
    ...
    for key, x in data_dict.iteritems():
        ...
        measurement_losses['vae'][key] = utils.get_measurement_loss(h_hat, Tx, Rx)
...
'''
    ...
    if hparams.save_images:
        utils.checkpoint(h_hats_dict, measurement_losses, l2_losses, save_image, hparams)
